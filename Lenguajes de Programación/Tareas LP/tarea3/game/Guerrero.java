...
public class Guerrero extends Jugador{
    ...
    */
    public int ataque(){
        ...
        int melee_damage = (get_fuerza() * 2) + get_energia();
    ...
    */
    public void subir_experiencia(int xp_ganada) {
        ...
        if (nuevo_level_actual != level_actual){
            System.out.println(get_nombre() + ": Buenagdou! subi de nivel " + level_actual + " a nivel " + nuevo_level_actual);
        }
        while (nuevo_level_actual != level_actual){
            set_max_vida(get_max_vida() + 3*nuevo_level_actual);
            set_fuerza(get_fuerza() + 5*nuevo_level_actual);
            set_inteligencia(get_inteligencia() + 1);
            set_max_energia(get_max_energia() + 2*nuevo_level_actual);
