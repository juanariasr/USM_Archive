...
import './MenuIntensidad.css';

const baseURL = "http://localhost:8000/emparejar";

const MenuIntensidad = ({ setIntensidadSelected }) => {
    ...
    const handleSubmit = event => {
        ...
        for (var i = 0; i < images.length; i++) {
            if (event.target[i].checked === true) {
                ...
                arrImgBd = [...arrImgBd, ...arr1];
                setIntensidadSelected(arrImgBd);
            }
            }
        navigate('/emparejar-intensidad');
    };
                        ...
                        <div>
                            ...
                            <form method="post" enctype="multipart/form-data" onSubmit={addImage}>
                                ...
                                <div>
                                    ...
                                    <datalist id="tipos">
                                    <option value="Suave"></option>
                                    <option value="Fuerte"></option>
                                    </datalist>
                                </div>
                                <div>
